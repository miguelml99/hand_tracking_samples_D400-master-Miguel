...
int main(int argc, const char **argv) try
{
	...
	//std::string afilename = argc >= 3 ? argv[2] : "../datasets/_Palma dedos juntos/hand_data_0.pose"; //Aqui indicamos el archivo de la pose que queremos simular
	std::string afilename = argc >= 3 ? argv[2] : "../datasets/_Puño cerrado/hand_data_0.pose"; //Aqui indicamos el archivo de la pose que queremos simular

	HandTracker htk(useLeft);
	htk.always_take_cnn = 1;
	...
	GLWin glwin("synthetic-hand-tracker demonstrating hand pose estimation with synthetically generated depth data", 320+320+100*2+4, 800);  // should fit 1080 allowing window's borders, taskbar 
