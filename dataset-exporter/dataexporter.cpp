...
//  Also creates two ascii text files labels_full.txt and labels_seg.txt that provide image xy locations of key locations and other values
...
int main(int argc, char *argv[]) try
{
	...
	for (int i = 1;i < argc;i++)
	{
		...
		//auto prefix = basepathname("../datasets/_Flexion muñeca/hand_data_0.rs");
