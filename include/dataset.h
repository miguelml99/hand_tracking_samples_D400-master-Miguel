...
{
	DCamera     dcamera;
	float4      mplane; //float4 refers to a float variable composes of 4 sets of floats 
	std::string fname;
	std::string camtype;
	bool        hasir = false;  // this was for interleaved ir to be depricated
	int2        rgb_dim;
	int2        feye_dim;
...
struct DepthDataStreamOut
{
	...
	std::ofstream file_out_feye;    // fish-eye  (D400 no tiene) 
	DepthDataStreamOut() {}
