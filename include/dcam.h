...
public:
	...
	inline bool Init()
	{
		...
		zintrin = depth_stream.get_intrinsics(); // Asocia las caracteristica intrinsecas del sensor detectado a las variable del programa que las definen como por ejemplo la distancia focal  
